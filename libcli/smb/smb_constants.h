...
#define FSCTL_GET_INTEGRITY_INFORMATION (FSCTL_FILESYSTEM | FSCTL_ACCESS_ANY | 0x027C | FSCTL_METHOD_BUFFERED)
#define FSCTL_SET_INTEGRITY_INFORMATION (FSCTL_FILESYSTEM | FSCTL_ACCESS_READ \
							  | FSCTL_ACCESS_WRITE | 0x0280 | FSCTL_METHOD_BUFFERED)
#define FSCTL_QUERY_FILE_REGIONS	(FSCTL_FILESYSTEM | FSCTL_ACCESS_ANY | 0x0284 | FSCTL_METHOD_BUFFERED)
